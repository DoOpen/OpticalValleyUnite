...
/*
 ...
 9. ems最新的bate环境 : http://pub.ovuems.com/
...
struct URLPath {
    ...
    //服务器的basicBasicPath
    static let basicBasic = "http://pub.ovuems.com"
    ...
    ///设备房 设备的接口
    //设备homelist
    static let getEquiphouseList = "equiphouse/list"
    //设备typelist
    ...
    //反馈列表查询（经理或总经理查看反馈列表）
    static let getemailList = "gm_email/list"
    //意见反馈批复接口
