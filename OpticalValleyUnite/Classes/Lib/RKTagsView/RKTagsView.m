...
#define DEFAULT_BUTTON_HORIZONTAL_PADDING 12
#define DEFAULT_BUTTON_VERTICAL_PADDING 12
...
//      tagButton.tintColor = self.tintColor;
      ...
      [tagButton setTitle:tag forState:UIControlStateNormal];
        tagButton.backgroundColor = [self colorWithHexString:@"f4f4f4"];
        [tagButton setTitleColor:[self colorWithHexString:@"878787"] forState:UIControlStateNormal];
...
//      self.mutableTagButtons[index].backgroundColor = self.tintColor;
        self.mutableTagButtons[index].backgroundColor = [self colorWithHexString:@"7f8892"];
        [self.mutableTagButtons[index] setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    }
  }
}
...
//      self.mutableTagButtons[index].backgroundColor = nil;
        self.mutableTagButtons[index].backgroundColor = [self colorWithHexString:@"f4f4f4"];
        [self.mutableTagButtons[index] setTitleColor:[self colorWithHexString:@"878787"] forState:UIControlStateNormal];
    }
  }
}
