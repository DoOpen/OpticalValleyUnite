...
-(void)awakeFromNib
{
    ...
    minYear = [[NSCalendar currentCalendar] components:NSCalendarUnitYear fromDate:[NSDate date]].year - 15;
    maxYear = minYear + 15;
...
-(NSDate *)date
{
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init]; [formatter setDateFormat:@"MM:yyyy"];
