...
//
//  Created by liuwei on 18/08/2017.
...
class MYPRefreshHeader: UIView {
    ...
    var mRefreshStatus:MRefreshStatus = .normal {
        ...
        didSet(oldValue) {
            ...
            case .refreshing:
                self.mRefreshImageView.animationImages = [UIImage.init(named: "refreshing1")!,UIImage.init(named: "refreshing2")!,UIImage.init(named: "refreshing3")!,UIImage.init(named: "refreshing4")!]
